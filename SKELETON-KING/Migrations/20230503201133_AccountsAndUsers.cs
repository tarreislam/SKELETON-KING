...
{
    /// <inheritdoc />
    public partial class AccountsAndUsers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MMPoints = table.Column<int>(type: "int", nullable: false),
                    Tickets = table.Column<int>(type: "int", nullable: false),
                    UnlockedUpgradeCodes = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UserName = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
                    NormalizedUserName = table.Column<string>(type: "nvarchar(15)", maxLength: 15, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IgnoredList = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Cookie = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: true),
                    AutoConnectChatChannels = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SelectedUpgradeCodes = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_Cookie",
                table: "Accounts",
                column: "Cookie",
                unique: true,
                filter: "[Cookie] IS NOT NULL");
