...
public class TrackPlayerActionRequest : ProtocolRequest<ConnectedClient>
{
    ...
    {
        // TODO: store performed action counter.
        if (Action == PlayerAction.OBTAIN_DETAILED_ONLINE_STATUS)
        {
            // Refresh online player count.
            connectedClient.SendResponse(new PlayerCountResponse(ChatServer.ConnectedClientsByAccountId.Count, details: ObtainDetailedOnlineStats()));
        }
    }
